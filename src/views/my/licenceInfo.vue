    ...
    <div class="id-box" v-if="editFlg">
      ...
      <div class="middle-box">
        <div class="middle-content">
          <div class="mid-top-text">上传驾驶证照片</div>
          <div class="id-img">
            <div>
              <van-uploader
                v-model="fileList"
        ...
        <div class="ocr-success" v-else>
          ...
          <div class="text-box" v-if="ocrResultFlg">
            <p class="ocr-text">
              ...
              <span class="edit-area">
                <van-icon name="edit" @click="$router.push({path:'/editLicenceInfo',query:{record: form}})" />
                编辑
              </span>
            </p>
            <p class="ocr-text">
            ...
            <p class="ocr-text">
              <span class="field-name">准驾车型：</span>
          ...
          <div class="fail-box" v-else>
            ...
            <van-button type="info" size="mini" @click="$router.push('/editLicenceInfo')">
              手动输入
            </van-button>
          </div>
        </div>      
...
import AfterLicenceUpload from './components/afterLicenceUpload'
import { 
  NavBar, 
  Button, 
  Divider, 
