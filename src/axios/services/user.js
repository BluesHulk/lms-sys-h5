import { get,postJson,patch,postFile,qs,post} from '../index.js'
...
const user={
  ...
  // 手机验证码登录
	loginByMsgCode(params){
		return postJson('/upms-management-provider/sys/user/login/msg-code',params)
	},
	// 注册用户校验
	registerCheck(data){
	...
	// 获取首页用户信息
	getuserInfo(){
		return get(`/upms-management-provider/sys/user/home-info`)
	},
	// 退出
	logout(){
