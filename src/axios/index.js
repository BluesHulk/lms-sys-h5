...
instance.defaults.baseURL = 'http://127.0.0.1:8080/lms/';
// instance.defaults.baseURL = 'http://192.168.19.27:8080/lms/';
...
function checkStatus(val) {
  console.log(val)
    ...
    sessionStorage.clear()
		...
		// location.href = `${location.protocol}//${location.host}/middleground-web/#/userlogin`;
	}else if (val.code != '0'){
